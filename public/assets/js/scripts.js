    ...
    for (i = 0;  i <= localStorage.length-1; i++){
       ...
       console.log(id);
        ...
        item = 
              ...
              '<div class="card mb-3" style="max-width: 1300px; margin-left: 20px; margin-top: 17px; box-shadow: rgba(0, 0, 0, 0.40)  0px 2.8px 7px 3px; background-color: lavenderblush">'+
            '<div class="row g-0">'+
               '<div class="col-md-4">'+
               ' <img style="width: 100%; height:336px; "  src="public/assets/img/fotos_productos/'+v.img+'" width="100%" alt="">'+
                ...
                '<div class="col-md-8">'+
                '<div class="card-body">'+
                    '<h3 class="card-title">'+v.nombre+'</h3><br>'+
                    '<h5 class="card-text">Precio $ '+v.precio+'</h5><br>'+
                    '<h5 class="card-text">Cantidad: '+v.cantidad+'</h5><br>'+
                    '<h6 class="card-text" style="font-family: sans-serif;">'+v.descripcion+'</h6>'+
                    '<h5 class="card-text" style="text-align:right;">Subtotal: '+(v.cantidad*v.precio)+'</h5>'+
                    '<input type="submit" name="eliminar" value="Eliminar" class="eICarrito btn btn-danger btn-lg" style="border-radius: 8px;" data-id="'+id+'">'+
                    '</div>'+
                '</div>'+
            '</div>'+
            '</div>'+
