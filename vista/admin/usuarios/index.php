    ...
    <div class="col-12">
        <div class="card my-4">
            ...
            <div class="card-body">
                    ...
                    <a class="btn btn-primary" href="?controlador=usuarios&accion=frmConsultar">Consultar Usuario</a>
                    <a class="btn btn-primary" href="?controlador=usuarios&accion=reporteUsuarios">Reportes</a> <br>
